...
class itemPageEquipment extends StatefulWidget{
  itemPageEquipment({Key? key, required this.id}) : super(key: key);
  final int id;


  @override
  _itemPageEquipmentState createState() => _itemPageEquipmentState();
}

class _itemPageEquipmentState extends State<itemPageEquipment>{
          ...
          Padding(
            ...
            child: Container(
              child: Row(
                ...
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  Flexible(child: Text("Equipment Modifier",
                    style: TextStyle(
                        fontWeight: FontWeight.bold,
                        fontSize: 18
                    ),
